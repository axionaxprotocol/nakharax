...
**Target Launch Date:** 1 September 2026 (T-Minus 7 Days)  
...
flowchart TB
    subgraph Mesh_Topology [NakharaX 5-Node Global Quorum Mesh]
        N1["Node 01: AU All-in-One Master Hub (Contabo 4C/8GB)\nIP: 46.250.244.4\nRole: Compute Master, Postgres, Redis, Explorer, Faucet"]
        N2["Node 02: EU Primary Validator (OVHcloud 2C/4GB NVMe)\nIP: 217.216.109.5\nRole: Genesis Validator #1, Fast NVMe State, Anti-DDoS RPC"]
        N3["Node 03: US East Satellite Worker (OVHcloud 2C/4GB NVMe)\nRole: Genesis Validator #3, PyTorch DeAI Worker (US Region)"]
        N4["Node 04: Asia-Pacific / SG Satellite Worker (OVHcloud 2C/4GB NVMe)\nRole: Genesis Validator #4, PyTorch DeAI Worker (Asia Region)"]
        N5["Node 05: EU West / UK Satellite Worker (OVHcloud 2C/4GB NVMe)\nRole: Genesis Validator #5, Audit & Backup Node"]
    end
...
| :--- | :--- | :--- | :--- | :---: | :---: |
| **Node 01 (AU Hub)** | **Contabo Cloud VPS 4** | 4 vCPU / 8 GB RAM / 100 GB SSD | Master Compute Hub, DB, Explorer, Faucet | **$5.28** | ~185 บาท |
| **Node 02 (EU Central)** | **OVHcloud VPS-1** | 2 vCPU / 4 GB RAM / 40 GB NVMe | Genesis Validator #1, Public Anti-DDoS RPC | **$4.54** | ~160 บาท |
| **Node 03 (US East)** | **OVHcloud VPS-1** | 2 vCPU / 4 GB RAM / 40 GB NVMe | Genesis Validator #3, DeAI Worker (US) | **$4.54** | ~160 บาท |
| **Node 04 (SG/Asia)** | **OVHcloud VPS-1** | 2 vCPU / 4 GB RAM / 40 GB NVMe | Genesis Validator #4, DeAI Worker (Asia) | **$4.54** | ~160 บาท |
| **Node 05 (EU West)** | **OVHcloud VPS-1** | 2 vCPU / 4 GB RAM / 40 GB NVMe | Genesis Validator #5, Audit & State Backup | **$4.54** | ~160 บาท |
| **รวมทั้งระบบ (Total)** | **5 Nodes Global Mesh** | **12 vCPU / 24 GB RAM / 260 GB Storage** | **1 Master Hub + 4 Satellites Mesh** | **$23.44** | **~825 บาท** |

---

## 3. สรุปความพร้อมของสถาปัตยกรรม 5 โหนด
