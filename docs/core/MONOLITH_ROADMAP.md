...
| **Core tech** | Silicon (ARM + NPU)<br/>RPi 5 + Hailo / Jetson | Custom ASIC / FPGA<br/>Nakharax-specific chip | Photonic Computing<br/>Light-based compute | Bio-Synthetic / Quantum<br/>Biological + quantum chip |
...
*This document is the single source of truth for Monolith hardware generations in Nakharax Core Universe.*
