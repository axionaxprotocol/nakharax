...
echo "  eth_getTransactionReceipt: curl -X POST https://rpc-au.nakharax.com -H 'Content-Type: application/json' -d '{\"jsonrpc\":\"2.0\",\"method\":\"eth_getTransactionReceipt\",\"params\":[\"0x...\"],\"id\":1}'"
echo "  eth_gasPrice: curl -X POST https://rpc-au.nakharax.com -H 'Content-Type: application/json' -d '{\"jsonrpc\":\"2.0\",\"method\":\"eth_gasPrice\",\"params\":[],\"id\":1}'"
echo "  net_peerCount: curl -X POST https://rpc-au.nakharax.com -H 'Content-Type: application/json' -d '{\"jsonrpc\":\"2.0\",\"method\":\"net_peerCount\",\"params\":[],\"id\":1}'"
echo "  staking_getStats: curl -X POST https://rpc-au.nakharax.com -H 'Content-Type: application/json' -d '{\"jsonrpc\":\"2.0\",\"method\":\"staking_getStats\",\"params\":[],\"id\":1}'"
