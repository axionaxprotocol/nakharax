...
# Main execution
Write-Header "nakharax VPS Deployment - Pre-Flight Check"
...
Write-ColorOutput "scp -r ../nakharax-deploy root@${vpsIP}:/opt/" "Cyan"
Write-Host ""
...
Write-ColorOutput "ssh root@$vpsIP" "Cyan"
Write-ColorOutput "cd /opt/nakharax-deploy" "Cyan"
...
Write-ColorOutput "ssh root@$vpsIP" "Cyan"
Write-Host ""
Write-Info "After connecting, navigate to: cd /opt/nakharax-deploy"
Write-Host ""

# Save connection info to file
$connectionInfo = @"
# nakharax VPS Connection Info
...
# Upload Files
scp -r ../nakharax-deploy root@${vpsIP}:/opt/
