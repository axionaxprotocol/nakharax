...
This directory documents the **Optical Logic Simulation** for Nakharax Monolith Mark-II. The actual simulation code lives in:
...
## Simulation Report (vs Nakharax v1.9 Silicon)
