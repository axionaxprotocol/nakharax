//! nakharax Protocol Configuration Module
//!
...
impl NetworkConfig {
    ...
    pub fn testnet() -> Self {
        Self {
            chain_id: 86137,
            network_name: "nakharax-testnet".to_string(),
    ...
    pub fn mainnet() -> Self {
        Self {
            chain_id: 86150,
            network_name: "nakharax-mainnet".to_string(),
            block_time_seconds: 5,
            max_peers: 100,
            bootstrap_nodes: vec![],
        }
...
mod tests {
    ...
    fn test_network_testnet() {
        ...
        assert_eq!(config.network_name, "nakharax-testnet");
    }
    ...
    fn test_network_mainnet() {
        ...
        assert_eq!(config.network_name, "nakharax-mainnet");
    }
