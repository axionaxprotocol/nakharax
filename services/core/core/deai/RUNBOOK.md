...
scp services/core/reports/deai-queue/job-*.json \
  root@rpc.axionax.org:/root/axionax-monolith/services/core/reports/deai-queue/
```
...
scp root@rpc.axionax.org:/root/axionax-monolith/services/core/reports/deai-queue/result-*.json \
