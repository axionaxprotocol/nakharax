...
scp services/core/reports/deai-queue/job-*.json \
  root@rpc.nakhara.io:/root/nakhara-monolith/services/core/reports/deai-queue/
```
...
scp root@rpc.nakhara.io:/root/nakhara-monolith/services/core/reports/deai-queue/result-*.json \
