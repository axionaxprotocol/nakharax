...
## 🔗 Network Details
- **RPC Endpoint (Primary)**: `https://rpc.nakharaxx.io` (EU Validator)
- **RPC Endpoint (Backup)**: `https://rpc-au.nakharaxx.io` (AU Validator)
...
1.  Check RPC: `curl https://rpc.nakharaxx.io`
