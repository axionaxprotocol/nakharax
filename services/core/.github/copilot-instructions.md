...
async fn test_connect_to_testnet() -> Result<()> {
    ...
    let config = NodeConfig {
        chain_id: 86137,
        bootstrap_nodes: vec![
            "/ip4/testnet1.nakharaxx.io/tcp/30303/p2p/...".to_string(),
        ],
        ..Default::default()
    };
...
# Test connectivity
telnet bootstrap1.nakharaxx.io 30303
...
# Test DNS resolution
nslookup bootstrap1.nakharaxx.io

# Check if bootstrap nodes are reachable
ping bootstrap1.nakharaxx.io
