...
Usage (from repo root):
  ...
  python scripts/generate_network_performance_report.py --rpc https://rpc.nakharaxx.io --light-duration 60 --block-duration 90
...
def main() -> int:
    ...
    ap.add_argument("--rpc", default="https://rpc.nakharaxx.io", help="JSON-RPC URL")
