...
Usage:
  ...
  python3 scripts/deploy-contracts.py --rpc https://rpc.nakharax.com --key 0x...
  python3 scripts/deploy-contracts.py --rpc https://rpc.nakharax.com --key 0x... --axx-token 0x...
...
def main():
    ...
    ap.add_argument("--rpc", default=os.environ.get("NAKHARAX_RPC_URL", "https://rpc.nakharax.com"))
