...
const APPS: App[] = [
  ...
  },
  {
    ...
    desc: "Live Continual Learning. Fuse domain LoRA adapters into base models via TIES and DARE without catastrophic forgetting.",
    icon: GitMerge,
    tone: "ai",
    state: "live",
    href: "/apps/lora",
  },
  {
    ...
    desc: "Live Agentic Runtime. Mint sovereign DIDs, equip specialized MCP skills, and manage inter-agent micro-economies.",
    icon: Bot,
    tone: "violet",
    state: "live",
    href: "/apps/agents",
