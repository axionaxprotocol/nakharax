...
const PLANNED_VPS_BLUEPRINTS: ClusterNode[] = [
  ...
  },
  {
    ...
    latencyMs: 14,
    blockHeight: 1250,
    hostingTier: "Contabo VPS (€6/mo) · Active Mesh",
  },
  {
    id: "node-sydney-val2",
  ...
  },
  {
    ...
    name: "Virginia PyTorch Inference Cluster (US-03)",
    ...
    latencyMs: 165,
    blockHeight: 1250,
    hostingTier: "NVIDIA A40 GPU Worker · Active Mesh",
  },
  {
    id: "node-tokyo-gpu1",
    name: "Tokyo GPU Accelerated Compute (JP-04)",
    region: "Tokyo, Japan",
    ...
    latencyMs: 82,
    blockHeight: 1250,
    hostingTier: "RunPod RTX 4090 · Active Mesh",
  },
  {
    ...
    latencyMs: 46,
    blockHeight: 1250,
    hostingTier: "Singapore Edge Node · Active Mesh",
  },
  {
    id: "node-london-auditor",
    name: "London ZK State Auditor & Radar (UK-06)",
    ...
    latencyMs: 172,
    blockHeight: 1250,
    hostingTier: "Dedicated ZK Auditor · Active Mesh",
  },
];
