    ...
    <header className="fixed inset-x-0 top-0 z-40 h-14 border-b border-white/[0.12] bg-slate-950/75 shadow-[0_4px_30px_rgba(0,0,0,0.6)] backdrop-blur-3xl">
      ...
      <div className="mx-auto flex h-full max-w-[1500px] items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2.5 sm:gap-3">
          ...
          <Link
            href="/wallet"
            className="inline-flex items-center gap-1.5 rounded-xl border border-cyan-500/30 bg-cyan-500/10 hover:bg-cyan-500/20 px-3 py-1.5 text-xs font-mono font-semibold text-cyan-300 transition-all hover:shadow-[0_0_12px_rgba(34,211,238,0.25)] hover:border-cyan-400/50"
          >
